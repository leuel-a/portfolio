...
export function IconsMarquee() {
    return (
        <div className="mt-40 flex justify-center md:mt-20">
            <div className="relative w-1/2 overflow-x-hidden bg-very-dark-blue py-4">
                ...
                <div className="pointer-events-none absolute inset-y-0 left-0 w-60 bg-gradient-to-r from-very-dark-blue to-transparent" />{' '}
                <div className="pointer-events-none absolute inset-y-0 right-0 w-60 bg-gradient-to-l from-very-dark-blue to-transparent" />
            </div>
        </div>
    );
}
